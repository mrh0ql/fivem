...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginContent(const char* str_id, const ImVec2& size_arg, bool border, ImGuiWindowFlags extra_flags);
    IMGUI_API void          EndContent();
    ...
    IMGUI_API bool          BeginCombo(const char* label, const char* preview_value, int val, ImGuiComboFlags flags = 0, bool multi = false);
...
enum ImGuiWindowFlags_
{
    ...
    // [Custom]
    ImGuiWindowFlags_WithoutScrollClamp     = 1 << 29
};
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddRectFilledMultiColor(const ImVec2& p_min, const ImVec2& p_max, ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left, float rounding = 0.f, ImDrawFlags flags = 0);
