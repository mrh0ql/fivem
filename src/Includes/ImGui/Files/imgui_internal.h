...
//#endif
    ...
    IMGUI_API bool          CustomSelectableEx(const char* label, bool active);
    IMGUI_API bool          CustomSelectable(const char* label, bool* p_selected);
    ...
    IMGUI_API bool          ListSelectableEx(const char* Label, bool Selected);
    IMGUI_API bool          ListSelectable(const char* label, bool* p_selected);
