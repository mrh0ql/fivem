...
bool ImGui::SliderScalar( const char * label, ImGuiDataType data_type, void * p_data, const void * p_min, const void * p_max, const char * format, ImGuiSliderFlags flags )
{
	...
	struct Slider_t {
		ImVec4 BackGroundCol = ImColor( 18, 18, 21 );
		float Slow;
	};
	...
	SliderAnim->second.BackGroundCol = ImLerp( SliderAnim->second.BackGroundCol, Hovered ? ImColor( 20, 20, 23 ) : ImColor( 18, 18, 21 ), g.IO.DeltaTime * 6.f );

	Window->DrawList->AddRectFilled( SliderRect.Min, SliderRect.Max, ImGui::GetColorU32( SliderAnim->second.BackGroundCol ), 5 );
	Window->DrawList->AddRect( SliderRect.Min, SliderRect.Max, ImGui::GetColorU32( ImVec4( ImColor( 24, 24, 26 ) ) ), 5 );
	Window->DrawList->AddRectFilled( ImVec2( SliderRect.Min.x, SliderRect.Min.y ), ImVec2( SliderRect.Min.x + SliderAnim->second.Slow, SliderRect.Max.y ), ImGui::GetColorU32( g_Col.Base ), 5 );
...
bool ImGui::Keybind( const char * label, int * key, int * mode )
{
	...
	window->DrawList->AddRectFilled( ImVec2( rect.Max.x - it_anim->second.PosX, rect.Min.y ), ImVec2( rect.Max.x + 6, rect.Max.y ), GetColorU32( ImVec4( ImColor( 20, 20, 22 ) ) ), 4 );
