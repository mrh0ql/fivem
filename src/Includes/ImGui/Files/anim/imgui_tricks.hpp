...
namespace imtricks {
	...
	*/
	namespace notify {
		...
		extern std::vector<notify_structure> notifies;
		...
		*/
		extern void send_notify( const char * title, const char * message, NotifyState state );
		...
		*/
		extern void render_notifies( ImDrawList * draw );
